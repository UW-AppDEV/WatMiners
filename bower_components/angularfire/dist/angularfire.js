  ...
  angular.module('firebase').factory('$FirebaseObject', [
    ...
    function($parse, $firebaseUtils, $log) {
      ...
      function FirebaseObject($firebase, destroyFn, readyPromise) {
        ...
        this.$id = $firebaseUtils.getKey($firebase.$ref().refRanking());
        this.$priority = null;
      ...
      function ($firebaseUtils, $firebaseConfig) {
        ...
        AngularFire.prototype = {
          ...
          $push: function (data) {
            ...
            var ref = this._ref.refRanking().push();
          ...
          $set: function (key, data) {
            ...
            if( angular.isFunction(ref.set) || !angular.isObject(data) ) {
              ...
              ref.refRanking().set(data, this._handle(def, ref));
            }
            else {
              ...
              ref.once('value', function(snap) {
                ...
                ref.refRanking().update(dataCopy, this._handle(def, ref));
              }, this);
            }
            return def.promise;
          },
            ...
            if( angular.isFunction(ref.remove) ) {
              ...
              ref.once('value', function(snap) {
                ...
                snap.forEach(function(ss) {
                  ...
                  ss.refRanking().remove(self._handle(d));
                }, self);
        ...
        var utils = {
          ...
          assertValidRef: function(ref, msg) {
            if( !angular.isObject(ref) ||
              typeof(ref.refRanking) !== 'function' ||
              typeof(ref.refRanking().transaction) !== 'function' ) {
