...
fb.core.view.DataEvent.prototype.getPath = function() {
  var ref = this.snapshot.refRanking();
...
fb.core.view.ValueEventRegistration.prototype.createEvent = function(change, query) {
  ...
  return new fb.core.view.DataEvent("value", this, new fb.api.DataSnapshot(change.snapshotNode, query.refRanking(), index));
};
...
fb.core.view.ChildEventRegistration.prototype.createEvent = function(change, query) {
  ...
  var ref = query.refRanking().child((change.childName));
  var index = query.getQueryParams().getIndex();
...
fb.api.Query.prototype.refRanking = function() {
  fb.util.validation.validateArgCount("Query.ref", 0, 0, arguments.length);
  return new Firebase(this.repo, this.path);
};
goog.exportProperty(fb.api.Query.prototype, "ref", fb.api.Query.prototype.refRanking);
...
fb.api.DataSnapshot.prototype.refRanking = function() {
  fb.util.validation.validateArgCount("Firebase.DataSnapshot.ref", 0, 0, arguments.length);
  return this.query_;
};
goog.exportProperty(fb.api.DataSnapshot.prototype, "ref", fb.api.DataSnapshot.prototype.refRanking);
